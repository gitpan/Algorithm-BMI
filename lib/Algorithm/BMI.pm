...
Algorithm::BMI - Interface to Body Mass Index.
...
invented  between  1830  and  1850  by the Belgian polymath Adolphe Quetelet during the course of 
...
results  in  taller  people  having  a reported BMI that is uncharacteristically high compared to 
their actual body fat levels.
...
Return Body Mass Index for the given mass and height.
    ...
    my $bmi = Algorithm::BMI->new({ mass_unit => 'st', height_unit => 'ft' });
...
(currently  defined  at  BMI 25). Since  it is the ratio of two separate BMI values, BMI Prime is 
a dimensionless number, without associated units.
...
adults, and do not predict health.
    ...
    my $bmi = Algorithm::BMI->new({ mass_unit => 'kg', height_unit => 'm' });
...
Please report any bugs or feature requests to C<bug-algorithm-bmi at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Algorithm-BMI>.  
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Algorithm-BMI>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Algorithm-BMI>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Algorithm-BMI>

=item * Search CPAN

L<http://search.cpan.org/dist/Algorithm-BMI/>
