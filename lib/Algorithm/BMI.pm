...
It expects optionally reference to an anonymous hash with the following keys:
    ...
    my $bmi_1 = Algorithm::BMI->new({ mass_unit => 'st', height_unit => 'ft' });

	# or simply

    my $bmi_2 = Algorithm::BMI->new();
...
the  web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=Algorithm-BMI>.  I will
